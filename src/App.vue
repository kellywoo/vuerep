<template>
  <div id="app" class="client">
    ...
    <v-autoscroll class="app-content">
      ...
      <v-autoscroll-section title="Vuetiful" class="left bg-fff">
        <page-blog class="app-pad" title="Vuetiful Korea"></page-blog>
      </v-autoscroll-section>
      <v-autoscroll-section title="Contact" class="bg-fff" :min-height="'80vh'">
        <page-contact title="Contact"></page-contact>
      </v-autoscroll-section>
    </v-autoscroll>
    <footer class="app-footer">
      <p class="f-roboto">© Copyright 2017 Vuetiful Korea All Rights Reserved</p>
    </footer>
  </div>
</template>
<script>
